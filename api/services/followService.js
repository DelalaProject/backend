...
const {getIo, joinRoom, leaveRoom} = require('../services/socketIoService');
...
const follow = async (req, res) => {
    ...
    joinRoom(req.body.followedId.toString() + "followers", req.userId);
...
const unfollow = async (req, res) => {
    ...
    leaveRoom(req.body.followedId.toString() + "followers", req.userId);
